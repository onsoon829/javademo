...
public class Java129_RegEx {
	...
	public static void main(String[] args) {
		...
		// a-zA-Z_*$가 sn변수에 포함이 되여 있으면 true 아니면 false을 리턴한다.
				...
				System.out.println(sn.matches(".*[^0-9].*"));// ^: not의 의미
				System.out.println(sn.matches(".*[\\D].*")); //대문자: not의 의미
...
//matches() : 패턴이 전체 문자열과 일치하면 True
				...
				Pattern ptPattern = Pattern.compile("best", Pattern.CASE_INSENSITIVE);//대소문자 구분 없이 best 단어 가져와라.
